...
class EditAccountContainer extends React.Component<IProps, IState> {
    ...
    public render() {
        ...
        return (
            <ProfileQuery 
                query={USER_PROFILE} 
                fetchPolicy={"cache-and-network"} // cache 를 확인하고 동작하지 않으면 네트워크로 가도록 fetch policy 를 정한다.
            ...
            >
                {() => (
                    <UpdateProfileMutation 
                        ...
                        variables = {{
                            email, firstName, lastName, profilePhoto
                        }}
                    >
    ...
    public onInputChange: React.ChangeEventHandler<HTMLInputElement> = async event => {
        ...
        if(files) {
            ...
            formData.append("api_key", "128732t83t812");
            formData.append("upload_preset", "qwer");
